...
--
-- group_members 테이블 자체에는 select 정책이 없으므로(SECURITY DEFINER 함수로만
-- 접근), 정책 안에서 group_members를 직접 조회하면 RLS에 막혀 항상 빈 결과로
-- 평가됩니다. 따라서 SECURITY DEFINER 함수로 감싸서 그 안에서 확인합니다.
-- =========================================================
